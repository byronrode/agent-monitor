...
function RunCard({ run, onSelect }: { run: Run; onSelect: (id: string) => void }) {
  ...
  return (
    <button
      type="button"
      className="grid w-full grid-cols-[84px_1fr_auto] items-center gap-3 rounded-xl border border-[var(--border)]/60 bg-[var(--surface)] px-4 py-3 text-left font-sans transition hover:border-[var(--border-hover)] hover:bg-[var(--surface-2)]/40 max-lg:grid-cols-1 max-lg:gap-2 max-lg:px-3.5 max-lg:py-3"
...
function LaneCard({ run, onSelect }: { run: Run; onSelect: (id: string) => void }) {
  ...
  return (
    <button
      type="button"
      className="w-full rounded-lg border border-[var(--border)]/60 bg-[var(--surface-2)]/45 px-3 py-2.5 text-left font-sans transition hover:border-[var(--border-hover)] hover:bg-[var(--surface-2)]/70"
      onClick={() => onSelect(run.runId)}
    >
